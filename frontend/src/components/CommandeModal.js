        ...
        <Modal.Header closeButton>
          <Modal.Title>
            <h5 className="modal-title">
              Formulaire pour ajouter une nouvelle demande d'une Commande pour
              la session avec l'ID : {sessionId}
            </h5>
          </Modal.Title>
        </Modal.Header>
                    ...
                    {!product.showFournisseurDetails && (
                      <Form.Group className="mb-3">
                        ...
                        <InputGroup className="mb-3">
                          ...
                          >
                            <option value="">
                              Selectionner un fournisseur existant dans la base
                              de donnée
                            </option>
                            {suppliers.length > 0 &&
                              suppliers.map((f) => (
